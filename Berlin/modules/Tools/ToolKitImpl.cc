...
// Graphic_ptr Berlin::ToolKit::ToolKitImpl::indicator(Graphic_ptr g, const Color &c, Telltale_ptr t)
// {
...
Controller_ptr Berlin::ToolKit::ToolKitImpl::text_input(Graphic_ptr g,
