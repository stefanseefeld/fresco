 ...
 * MA 02139, USA.
 */
#ifndef _WidgetKit_Motif_Scrollbar_hh
#define _WidgetKit_Motif_Scrollbar_hh
...
namespace Berlin
{
  namespace WidgetKit
  {
	...
	public:
	  Scrollbar(Fresco::BoundedRange_ptr, Fresco::Axis,
	...
	private:
	  ...
	  RefCount_var<Fresco::BoundedRange> my_value;
	  Offset my_offset;
	  Fresco::Axis my_axis;
