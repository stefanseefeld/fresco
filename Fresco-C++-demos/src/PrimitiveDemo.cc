...
PrimitiveDemo::Rotator::Rotator(BoundedValue_ptr v, Graphic_ptr c,
...
{
    RasterKit_var images = my_application->resolve<RasterKit>("IDL:fresco.org/Fresco/RasterKit:1.0");
    PrimitiveKit_var primitives = my_application->resolve<PrimitiveKit>("IDL:fresco.org/Fresco/PrimitiveKit:1.0");
    ...
    mesh.triangles[0].a = 0, mesh.triangles[0].b = 1,
    mesh.triangles[0].c = 3;
    mesh.triangles[1].a = 1, mesh.triangles[1].b = 2,
    mesh.triangles[1].c = 3;
    mesh.triangles[2].a = 2, mesh.triangles[2].b = 0,
    mesh.triangles[2].c = 3;
    mesh.triangles[3].a = 0, mesh.triangles[3].b = 2,
    mesh.triangles[3].c = 1;
    ...
    mesh.normals[2].x = -.2, mesh.normals[2].y = .2,
    mesh.normals[2].z = .2;
    ...
    my_application->append(bar, Babylon::String("Geometry"));
}

Graphic_ptr PrimitiveDemo::make_controller(BoundedValue_ptr value,
                       const Color &color)
{
    ToolKit_var tools = my_application->resolve<ToolKit>("IDL:fresco.org/Fresco/ToolKit:1.0");
    WidgetKit_var widgets = my_application->resolve<WidgetKit>("IDL:fresco.org/Fresco/WidgetKit:1.0");
