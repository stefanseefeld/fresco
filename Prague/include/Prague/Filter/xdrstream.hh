...
namespace Prague
{
  ...
  class oxdrstream : public xdrios
  {
    ...
    public:
      ...
      oxdrstream &operator << (bool b)
      {
          bool_t tbool = b ? TRUE : FALSE;
          state = state == TRUE && xdr_bool(xdrstream(), &tbool);
          return *this;
      }

      oxdrstream &operator << (char c)
      {
          state = state == TRUE && xdr_char(xdrstream(), &c);
          return *this;
      }
      oxdrstream &operator << (unsigned char c)
      {
          state = state == TRUE && xdr_u_char(xdrstream(), &c);
          return *this;
      }
      oxdrstream &operator << (signed char c)
      {
          state = state == TRUE && xdr_char(xdrstream(), reinterpret_cast<char *> (&c));
          return *this;
      }

      oxdrstream &operator << (double d)
      {
          state = state == TRUE && xdr_double(xdrstream(), &d);
          return *this;
      }
      oxdrstream &operator << (float f)
      {
          state = state == TRUE && xdr_float(xdrstream(), &f);
          return *this;
      }

      oxdrstream &operator << (int i)
      {
          state = state == TRUE && xdr_int(xdrstream(), &i);
          return *this;
      }
      oxdrstream &operator << (long l)
      {
          state = state == TRUE && xdr_long(xdrstream(), &l);
          return *this;
      }
      oxdrstream &operator << (short s)
      {
          state = state == TRUE && xdr_short(xdrstream(), &s);
          return *this;
      }

      oxdrstream &operator << (unsigned int i)
      {
          state = state == TRUE && xdr_u_int(xdrstream(), &i);
          return *this;
      }
      oxdrstream &operator << (unsigned long l)
      {
          state = state == TRUE && xdr_u_long(xdrstream(), &l);
          return *this;
      }
      oxdrstream &operator << (unsigned short s)
      {
          state = state == TRUE && xdr_u_short(xdrstream(), &s);
          return *this;
      }
  ...
  class ofxdrstream : public oxdrstream
  {
    ...
    public:
      ofxdrstream(char const *fname) :
        oxdrstream((new filebuf())->open(fname, ios::out|ios::binary))
      { }
      ~ofxdrstream()
      {
          filebuf *fb = static_cast<filebuf *> (rdbuf());
          rdbuf(0);
          delete fb;
      }
  };
  ...
  class ixdrstream : public xdrios
  {
    ...
    public:
      ...
      ixdrstream &operator >> (bool &b)
      {
          bool_t tbool;
          state = state == TRUE && xdr_bool(xdrstream(), &tbool);
          b = tbool == TRUE ? true : false;
          return *this;
      }

      ixdrstream &operator >> (char &c)
      {
          state = state == TRUE && xdr_char(xdrstream(), &c);
          return *this;
      }
      ixdrstream &operator >> (unsigned char &c)
      {
          state = state == TRUE && xdr_u_char(xdrstream(), &c);
          return *this;
      }
      ixdrstream &operator >> (signed char &c)
      {
          state = state == TRUE && xdr_char(xdrstream(), reinterpret_cast<char *> (&c));
          return *this;
      }

      ixdrstream &operator >> (double &d)
      {
          state = state == TRUE && xdr_double(xdrstream(), &d);
          return *this;
      }
      ixdrstream &operator >> (float &f)
      {
          state = state == TRUE && xdr_float(xdrstream(), &f);
          return *this;
      }

      ixdrstream &operator >> (int &i)
      {
          state = state == TRUE && xdr_int(xdrstream(), &i);
          return *this;
      }
      ixdrstream &operator >> (long &l)
      {
          state = state == TRUE && xdr_long(xdrstream(), &l);
          return *this;
      }
      ixdrstream &operator >> (short &s)
      {
          state = state == TRUE && xdr_short(xdrstream(), &s);
          return *this;
      }

      ixdrstream &operator >> (unsigned int &i)
      {
          state = state == TRUE && xdr_u_int(xdrstream(), &i);
          return *this;
      }
      ixdrstream &operator >> (unsigned long &l)
      {
          state = state == TRUE && xdr_u_long(xdrstream(), &l);
          return *this;
      }
      ixdrstream &operator >> (unsigned short &s)
      {
          state = state == TRUE && xdr_u_short(xdrstream(), &s);
          return *this;
      }
  ...
  class ifxdrstream : public ixdrstream
  {
    ...
    public:
      ifxdrstream(char const *fname) :
        ixdrstream((new filebuf())->open(fname, ios::in|ios::binary))
      { }
      ~ifxdrstream()
      {
          filebuf *fb = static_cast<filebuf *> (rdbuf());
  ...
  inline xdrios::xdrios(streambuf *sb, xdrios::operation op) :
    state(TRUE),
    sbuf(sb),
    xdrs(static_cast<XDR *>(operator new(sizeof(XDR)))),
    len(0)
  {
