    ...
    public:
      ...
      class ftpbuf : public protocol::protocolbuf
      {
        public:
          ...
          ftp::replycodea user(const char* name)
          { return send_cmd("USER", name); }
          ftp::replycodea passwd(const char* pw)
          {return send_cmd("PASS", pw); }
          ftp::replycodea acct(const char* ac)
          {return send_cmd("ACCT", ac); }
