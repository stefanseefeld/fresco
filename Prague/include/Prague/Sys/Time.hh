...
namespace Prague
{
  ...
  class Time : public timeval
  {
    public:
      ...
      { tv_sec = t.tv_sec, tv_usec = t.tv_nsec/1000; normalize(); }
      Time(long l)
      { tv_sec = l/1000, tv_usec = (l - tv_sec*1000)*1000; }
      ...
      { tv_sec += T.tv_sec, tv_usec += T.tv_usec; normalize(); return *this; }
      Time &operator -= (const Time &T)
      { tv_sec -= T.tv_sec, tv_usec -= T.tv_usec; normalize(); return *this; }
      Time operator +  (const Time &T) const
      { Time t = *this; t += T; return t; }
      Time operator -  (const Time &T) const
      { Time t = *this; t -= T; return t; }
      operator bool () const
      { return tv_sec != 0 || tv_usec != 0; }
      operator timespec () const
      { timespec t; t.tv_sec = tv_sec, t.tv_nsec = tv_usec * 1000; return t; }
      operator double () const
      { return static_cast<double>(tv_sec) + static_cast<double>(tv_usec)/1000000.; }
      ...
      { return os << T.tv_sec << " s, " << T.tv_usec << " us"; }
    protected:
