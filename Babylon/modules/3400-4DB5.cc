 ...
 * ftp.unicode.org on Wed, 15 Nov 2000 23:28:45 +0100.
 *
...
namespace Babylon {
  ...
  class CJK_Unified_Ideographs_Extension_A : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };
  ...
  private:
    // functions
    CJK_Unified_Ideographs_Extension_A(const CJK_Unified_Ideographs_Extension_A &) {}
...
dload(Babylon::CJK_Unified_Ideographs_Extension_A);
