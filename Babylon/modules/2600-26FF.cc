/*$Id: UnicodePluginGenerator.pl,v 1.5 2001/05/06 12:18:46 tobias Exp 2600-26FF.cc
 *
...
namespace Babylon {
  ...
  private:
    ...
    const std::bitset<256> Miscellaneous_Symbols2600::m_is_defined(std::string(""));
