...
namespace Babylon {
  ...
  private:
    ...
    const bitset<256> Enclosed_CJK_Letters_and_Months3200::m_is_defined(string(""));
  ...
  const UCS4 Enclosed_CJK_Letters_and_Months3200::m_decompStr[][2] = {
    ...
    const bitset<256> Enclosed_CJK_Letters_and_Months3200::m_Composite(string(""));
