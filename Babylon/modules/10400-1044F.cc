/*$Id: UnicodePluginGenerator.pl,v 1.11 2004/01/28 12:39:04 tobias Exp 10400-1044F.cc
 *
...
namespace Babylon
{
  namespace Module
  {
    class Deseret10400 : public Babylon::Block
    {
      public:
        void clean() { };

        Deseret10400() :
        my_first_letter(0x10400),
        my_last_letter(0x1044F)
    ...
    std::string blockname(const UCS4 uc) const
    {
        ...
        {
            return Deseret10400::my_upper[uc - my_first_letter];
        }

        UCS4 lowercase(const UCS4 uc) const
        {
            return Deseret10400::my_lower[uc - my_first_letter];
        }

        UCS4 titlecase(const UCS4 uc) const
        {
            return Deseret10400::my_title[uc - my_first_letter];
        }
        ...
        Gen_Cat category(const UCS4 uc) const
        {
            if (!is_defined(uc))
                return CAT_MAX;
            return Babylon::Gen_Cat(Deseret10400::my_cat[uc - my_first_letter]);
        }
      ...
      private:
        // functions
        Deseret10400(const Deseret10400 &) ; // no implementaion!

    // members
        Babylon::UCS4 my_first_letter;
        Babylon::UCS4 my_last_letter;
        // Babylon::UCS4_string my_version;
        static const UCS4 my_upper[80];
        static const UCS4 my_lower[80];
        static const UCS4 my_title[80];
        static const unsigned char my_cat[80];
    }; // class Deseret10400

    const UCS4 Deseret10400::my_upper[] =
    {
    ...
    const UCS4 Deseret10400::my_lower[] =
    {
    ...
    const UCS4 Deseret10400::my_title[] =
    {
        0x10400, 0x10401, 0x10402, 0x10403, 0x10404, 0x10405, 0x10406, 0x10407, 
        0x10408, 0x10409, 0x1040A, 0x1040B, 0x1040C, 0x1040D, 0x1040E, 0x1040F, 
        0x10410, 0x10411, 0x10412, 0x10413, 0x10414, 0x10415, 0x10416, 0x10417, 
    ...
    const unsigned char Deseret10400::my_cat[] =
    {
...
dload(Babylon::Module::Deseret10400);
