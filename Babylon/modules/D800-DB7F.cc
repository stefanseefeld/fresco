/*$Id: UnicodePluginGenerator.pl,v 1.11 2004/01/28 12:39:04 tobias Exp D800-DB7F.cc
 *
 ...
 * ftp.unicode.org on Wed, 28 Jan 2004 20:49:42 +0100.
 *
...
namespace Babylon
{
  namespace Module
  {
    class High_SurrogatesD800 : public Babylon::Block
    {
      public:
        void clean() { };
    ...
    std::string blockname(const UCS4 uc) const
    {
      ...
      private:
        // functions
        High_SurrogatesD800(const High_SurrogatesD800 &) ; // no implementaion!
...
dload(Babylon::Module::High_SurrogatesD800);
