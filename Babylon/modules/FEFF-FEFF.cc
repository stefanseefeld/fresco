 ...
 * ftp.unicode.org on Wed, 15 Nov 2000 23:45:00 +0100.
 *
...
namespace Babylon {
  ...
  class Specials : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };

    Specials() {
      my_first_letter = 0xFEFF;
