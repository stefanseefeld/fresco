...
namespace Babylon {
  ...
  private:
    ...
    static const UCS2 m_decompStr[32];
    static const unsigned char m_lb[32];
    static const bitset<32> m_Dash;
    static const bitset<32> m_Identifier_Part_Not_Cf;

  }; // class CJK_Compatibility_FormsFE30

    const bitset<32> CJK_Compatibility_FormsFE30::m_is_defined(string("11111110000111111111111111111111"));
  ...
  const UCS2 CJK_Compatibility_FormsFE30::m_decompStr[] = {
  ...
  const unsigned char CJK_Compatibility_FormsFE30::m_lb[] = {
    ...
    const bitset<32> CJK_Compatibility_FormsFE30::m_Dash(string("00000000000000000000000000000110"));

    const bitset<32> CJK_Compatibility_FormsFE30::m_Identifier_Part_Not_Cf(string("11100000000000000000000000011000"));
