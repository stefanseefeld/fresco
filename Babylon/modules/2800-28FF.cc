 ...
 * ftp.unicode.org on Wed, 15 Nov 2000 23:27:43 +0100.
 *
...
namespace Babylon {
  ...
  class Braille_Patterns : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };
  ...
  private:
    // functions
    Braille_Patterns(const Braille_Patterns &) {}
 
    Babylon::_UCS4 my_first_letter;
    Babylon::_UCS4 my_last_letter;

  }; // class Braille_Patterns

}; // namespace Babylon
 
dload(Babylon::Braille_Patterns);
