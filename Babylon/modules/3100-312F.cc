 ...
 * ftp.unicode.org on Wed, 10 Jan 2001 16:57:39 +0100.
 *
...
namespace Babylon {
  ...
  class Bopomofo3100 : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };
  ...
  private:
    ...
    static const bitset<48> m_Alphabetic;
    static const bitset<48> m_Identifier_Part_Not_Cf;

  }; // class Bopomofo3100

    const bitset<48> Bopomofo3100::m_is_defined(string("000111111111111111111111111111111111111111100000"));

    const bitset<48> Bopomofo3100::m_Alphabetic(string("000111111111111111111111111111111111111111100000"));

    const bitset<48> Bopomofo3100::m_Identifier_Part_Not_Cf(string("000111111111111111111111111111111111111111100000"));

}; // namespace Babylon

dload(Babylon::Bopomofo3100);
