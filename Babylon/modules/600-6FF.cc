...
namespace Babylon {
  ...
  private:
    ...
    const bitset<256> Arabic600::m_is_defined(string(""));
  ...
  const unsigned char Arabic600::m_lb[] = {
    ...
    const bitset<256> Arabic600::m_Composite(string(""));

    const bitset<256> Arabic600::m_Alphabetic(string(""));

    const bitset<256> Arabic600::m_Diacritic(string(""));

    const bitset<256> Arabic600::m_Identifier_Part_Not_Cf(string(""));
