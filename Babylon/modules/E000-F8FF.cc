 ...
 * ftp.unicode.org on Wed, 15 Nov 2000 23:42:11 +0100.
 *
...
namespace Babylon {
  ...
  class Private_Use : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };
    ...
    Line_Break linebreak(const _UCS4 _uc) const {
      if (!isDefined(_uc))
        throw UndefinedProperty(_uc, PROP_CHARACTER);
      return Babylon::Line_Break(LB_AI);
    }
