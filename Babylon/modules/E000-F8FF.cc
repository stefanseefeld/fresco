/*$Id: UnicodePluginGenerator.pl,v 1.11 2004/01/28 12:39:04 tobias Exp E000-F8FF.cc
 *
 ...
 * ftp.unicode.org on Wed, 28 Jan 2004 20:49:44 +0100.
 *
...
namespace Babylon
{
  namespace Module
  {
    class Private_Use_AreaE000 : public Babylon::Block
    {
      public:
        void clean() { };
    ...
    std::string blockname(const UCS4 uc) const
    {
      ...
      private:
        // functions
        Private_Use_AreaE000(const Private_Use_AreaE000 &) ; // no implementaion!
...
dload(Babylon::Module::Private_Use_AreaE000);
