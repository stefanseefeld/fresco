 ...
 * ftp.unicode.org on Tue, 21 Nov 2000 21:30:10 +0100.
 *
...
namespace Babylon {
  ...
  class Plane_15_Private_Use_AreaF0000 : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };

    Plane_15_Private_Use_AreaF0000() {
      my_first_letter = 0xF0000;
      my_last_letter  = 0xFFFFD;
    ...
    string blockname(const UCS4 & _uc) const {
      return "Plane 15 Private Use Area";
    }
  ...
  private:
    // functions
    Plane_15_Private_Use_AreaF0000(const Plane_15_Private_Use_AreaF0000 &) {}
 
    Babylon::UCS4 my_first_letter;
    Babylon::UCS4 my_last_letter;

  }; // class Plane_15_Private_Use_AreaF0000

}; // namespace Babylon
 
dload(Babylon::Plane_15_Private_Use_AreaF0000);
