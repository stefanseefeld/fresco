 ...
 * ftp.unicode.org on Wed, 15 Nov 2000 23:45:12 +0100.
 *
...
namespace Babylon {
  ...
  class Plane_15_Private_Use_Area : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };

    Plane_15_Private_Use_Area() {
  ...
  private:
    // functions
    Plane_15_Private_Use_Area(const Plane_15_Private_Use_Area &) {}
 
    Babylon::_UCS4 my_first_letter;
    Babylon::_UCS4 my_last_letter;

  }; // class Plane_15_Private_Use_Area

}; // namespace Babylon
 
dload(Babylon::Plane_15_Private_Use_Area);
