/*$Id: UnicodePluginGenerator.pl,v 1.5 2001/05/06 12:18:46 tobias Exp 400-4FF.cc
 *
...
namespace Babylon {
  ...
  public:
    ...
    Bidir_Props bidir_props(const UCS4 uc) const {
      ...
      return Cyrillic400::m_bidir[uc - m_first_letter];
    }
  ...
  const Babylon::Bidir_Props Cyrillic400::m_bidir[] = {
