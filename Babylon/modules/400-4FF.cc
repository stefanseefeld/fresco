 ...
 * ftp.unicode.org on Wed, 10 Jan 2001 16:55:52 +0100.
 *
...
namespace Babylon {
  ...
  private:
    ...
    const bitset<256> Cyrillic400::m_is_defined(string(""));
  ...
  const unsigned char Cyrillic400::m_ea[] = {
    ...
    const bitset<256> Cyrillic400::m_Composite(string(""));

    const bitset<256> Cyrillic400::m_Alphabetic(string(""));

    const bitset<256> Cyrillic400::m_Diacritic(string(""));

    const bitset<256> Cyrillic400::m_Identifier_Part_Not_Cf(string(""));
