 ...
 * ftp.unicode.org on Wed, 10 Jan 2001 16:56:58 +0100.
 *
...
namespace Babylon {
  ...
  private:
    ...
    const bitset<256> Greek_Extended1F00::m_is_defined(string(""));
  ...
  const UCS2 Greek_Extended1F00::m_decompStr[][2] = {
    ...
    const bitset<256> Greek_Extended1F00::m_Composite(string(""));

    const bitset<256> Greek_Extended1F00::m_Alphabetic(string(""));

    const bitset<256> Greek_Extended1F00::m_Diacritic(string(""));

    const bitset<256> Greek_Extended1F00::m_Identifier_Part_Not_Cf(string(""));
