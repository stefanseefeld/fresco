 ...
 * ftp.unicode.org on Wed, 15 Nov 2000 23:41:54 +0100.
 *
...
namespace Babylon {
  ...
  class High_Private_Use_Surrogates : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };
  ...
  private:
    // functions
    High_Private_Use_Surrogates(const High_Private_Use_Surrogates &) {}
 
    Babylon::_UCS4 my_first_letter;
    Babylon::_UCS4 my_last_letter;

  }; // class High_Private_Use_Surrogates

}; // namespace Babylon
 
dload(Babylon::High_Private_Use_Surrogates);
