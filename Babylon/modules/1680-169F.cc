...
namespace Babylon {
  ...
  public:
    ...
    Ogham1680() {
      m_first_letter = 0x1680;
      m_last_letter  = 0x169F;
    ...
    Gen_Cat category(const UCS4 uc) const {
      if (!is_defined(uc))
        return CAT_MAX;
      return Babylon::Gen_Cat(Ogham1680::_cat[uc - m_first_letter]);
    }
    ...
    Line_Break linebreak(const UCS4 uc) const {
      if (!is_defined(uc))
        return LB_MAX;
      return Babylon::Line_Break(Ogham1680::m_lb[uc - m_first_letter]);
    }
  ...
  private:
    ...
    static const bitset<32> m_Alphabetic;
    static const bitset<32> m_Identifier_Part_Not_Cf;

  }; // class Ogham1680

    const bitset<32> Ogham1680::m_is_defined(string("00011111111111111111111111111111"));
  ...
  const unsigned char Ogham1680::m_lb[] = {
    ...
    const bitset<32> Ogham1680::m_Alphabetic(string("00000111111111111111111111111110"));

    const bitset<32> Ogham1680::m_Identifier_Part_Not_Cf(string("00000111111111111111111111111110"));
