...
namespace Babylon {
  ...
  const unsigned char Thaana780::m_lb[] = {
    ...
    const std::bitset<64> Thaana780::m_Other_Alphabetic(std::string("0000000000000001111111111100000000000000000000000000000000000000"));

    const std::bitset<64> Thaana780::m_Diacritic(std::string("0000000000000001111111111100000000000000000000000000000000000000"));
