/*$Id: UnicodePluginGenerator.pl,v 1.5 2001/05/06 12:18:46 tobias Exp 1D400-1D7FF.cc
 *
 ...
 * ftp.unicode.org on Fri, 11 May 2001 01:12:29 +0200.
 *
...
namespace Babylon {
  ...
  public:
    ...
    Bidir_Props bidir_props(const UCS4 uc) const {
      ...
      return Mathematical_Alphanumeric_Symbols1D400::m_bidir[uc - m_first_letter];
    }
  ...
  private:
    ...
    static const Babylon::Bidir_Props m_bidir[1024];
  ...
  const Babylon::Bidir_Props Mathematical_Alphanumeric_Symbols1D400::m_bidir[] = {
