 ...
 * ftp.unicode.org on Thu, 16 Nov 2000 00:02:19 +0100.
 *
...
namespace Babylon {
  ...
  class Plane_16_Private_Use_Area : public Babylon::Dictionary::Block {
  public:
    void clean () {
    };

    Plane_16_Private_Use_Area() {
      my_first_letter = 0x100000;
      my_last_letter  = 0x10FFFD;
  ...
  private:
    // functions
    Plane_16_Private_Use_Area(const Plane_16_Private_Use_Area &) {}
 
    Babylon::_UCS4 my_first_letter;
    Babylon::_UCS4 my_last_letter;

  }; // class Plane_16_Private_Use_Area

}; // namespace Babylon
 
dload(Babylon::Plane_16_Private_Use_Area);
