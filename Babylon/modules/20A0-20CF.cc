 ...
 * ftp.unicode.org on Wed, 10 Jan 2001 16:57:04 +0100.
 *
...
namespace Babylon {
  ...
  private:
    ...
    const bitset<48> Currency_Symbols20A0::m_is_defined(string("000000000000000000000000000000001111111111111111"));
