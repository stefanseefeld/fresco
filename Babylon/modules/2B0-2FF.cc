 ...
 * ftp.unicode.org on Wed, 10 Jan 2001 16:55:47 +0100.
 *
...
namespace Babylon {
  ...
  private:
    ...
    static const bitset<80> m_Extender;
    static const bitset<80> m_Identifier_Part_Not_Cf;
    static const bitset<80> m_Other_Lowercase;

  }; // class Spacing_Modifier_Letters2B0

    const bitset<80> Spacing_Modifier_Letters2B0::m_is_defined(string("00000000000000000111111111111111111111111111111111111111111111111111111111111111"));
  ...
  const unsigned char Spacing_Modifier_Letters2B0::m_ea[] = {
    ...
    const bitset<80> Spacing_Modifier_Letters2B0::m_Alphabetic(string("00000000000000000000000000011111000000000000000000000000000000111111100111111111"));

    const bitset<80> Spacing_Modifier_Letters2B0::m_Diacritic(string("00000000000000000011111111111111111111111111111111111111111111111111111111111111"));

    const bitset<80> Spacing_Modifier_Letters2B0::m_Extender(string("00000000000000000000000000000000000000000000001100000000000000000000000000000000"));

    const bitset<80> Spacing_Modifier_Letters2B0::m_Identifier_Part_Not_Cf(string("00000000000000000000000000011111000000000000001100000000000000111111100111111111"));

    const bitset<80> Spacing_Modifier_Letters2B0::m_Other_Lowercase(string("00000000000000000000000000011111000000000000000000000000000000110000000111111111"));
